        ...
        success: function (response) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed && result.value.status === 'success') {
                    ...
                    // Actualiza la fila del servicio en la tabla
                    var row = $('tr').filter(function() {
                        return $(this).find('td:first').text() == id; // Encuentra la fila por ID
                    });
...
function editarServicio(id) {
    $.ajax({
        ...
        success: function (response) {
            ...
            // Obtén las categorías y socios para llenar los desplegables
            $.when(
